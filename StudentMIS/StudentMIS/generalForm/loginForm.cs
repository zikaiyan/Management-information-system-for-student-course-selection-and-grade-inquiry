...
namespace StudentMIS
{
    ...
    {
        public static string connectionString = "uid=sa;pwd=sdlsjsnc00544;initial catalog=StudentMIS;Data Source=2A5B;Connect Timeout=900";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (role == "管理员")
                {
                    ...
                    {
                        conn.Close();
                        adminFrom mainframe = new adminFrom();
                ...
                else if (role == "学生")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        //this.Close();
                        conn.Close();
                        studentFrom mainframe = new studentFrom();
                        mainframe.BringToFront();
                        mainframe.Show();
                        this.Hide();
                    }
