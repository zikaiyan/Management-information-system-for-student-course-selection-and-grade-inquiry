...
{
    public partial class setupClassForm : Form
    {
        public setupClassForm()
        {
            InitializeComponent();
        }
        ...
        {
            //检查信息是否填写完整
            if (textBoxteacher.Text == "" || textBoxclass.Text == "" || comboBoxterm.Text == "" || comboBoxdidian.Text == "" || checkedListBoxtime.CheckedItems.Count == 0)
            {
        ...
        private void setupClassForm_Load(object sender, EventArgs e)
        {
