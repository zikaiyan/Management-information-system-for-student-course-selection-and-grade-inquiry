...
namespace StudentMIS
{
    public partial class addStudentForm : Form
    {
        ...
        {
            //判断信息是否填写完整
            if (textBoxname.Text == "" || textBoxpname.Text == "" || textBoxpasswd.Text == "" || comboBoxgrade.Text == "" || comboBoxmajor.Text == "" || textBoxhometown.Text == "" || !(radioButton1.Checked || radioButton2.Checked))
            {
