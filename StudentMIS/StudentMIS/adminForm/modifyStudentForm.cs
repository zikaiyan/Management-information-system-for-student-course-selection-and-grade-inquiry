...
namespace StudentMIS
{
    public partial class modifyStudentForm : Form
    {
        ...
        {
            // 判断信息是否完全
            if (textBoxid.Text == "" || textBoxborn.Text == "" || textBoxname.Text == "" || textBoxpname.Text == "" || textBoxpasswd.Text == "" || comboBoxgrade.Text == "" || comboBoxmajor.Text == "" || textBoxhometown.Text == "" || !(radioButton1.Checked || radioButton2.Checked))
            {
